{
  ...
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-cfbfcc4f-8250-4151-abe6-1f661e44db54" = [];
      "KDE Keyboard Layout Switcher"."Switch keyboard layout to English (US)" = [];
      "KDE Keyboard Layout Switcher"."Switch keyboard layout to 英语（美国）" = [];
      ...
      "kwin"."Move Window to the Bottom-Center" = "Meta+Num+2";
      "kwin"."Move Window to the Bottom-Left" = "Meta+Num+1";
      "kwin"."Move Window to the Bottom-Right" = "Meta+Num+3";
      "kwin"."Move Window to the Center" = "Meta+Num+5";
      "kwin"."Move Window to the Center-Left" = "Meta+Num+4";
      "kwin"."Move Window to the Center-Right" = "Meta+Num+6";
      "kwin"."Move Window to the Top-Center" = "Meta+Num+8";
      "kwin"."Move Window to the Top-Left" = "Meta+Num+7";
      "kwin"."Move Window to the Top-Right" = "Meta+Num+9";
      ...
      "yakuake"."toggle-window-state" = "Alt+F1";
    };
    configFile = {
      ...
      "kactivitymanagerdrc"."activities"."cfbfcc4f-8250-4151-abe6-1f661e44db54" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "cfbfcc4f-8250-4151-abe6-1f661e44db54";
      "kcminputrc"."Keyboard"."RepeatDelay" = 500;
      "kcminputrc"."Keyboard"."RepeatRate" = 100;
      "kcminputrc"."Libinput.1739.32552.SYNA0001:00 06CB:7F28 Touchpad"."ClickMethod" = 2;
      "kcminputrc"."Libinput.1739.32552.SYNA0001:00 06CB:7F28 Touchpad"."LmrTapButtonMap" = true;
      "kcminputrc"."Libinput.1739.32552.SYNA0001:00 06CB:7F28 Touchpad"."MiddleButtonEmulation" = true;
      "kcminputrc"."Libinput.1739.32552.SYNA0001:00 06CB:7F28 Touchpad"."NaturalScroll" = false;
      "kcminputrc"."Libinput.1739.32552.SYNA0001:00 06CB:7F28 Touchpad"."ScrollFactor" = 1;
      "kcminputrc"."Libinput.1739.32552.SYNA0001:00 06CB:7F28 Touchpad"."ScrollMethod" = 1;
      "kcminputrc"."Libinput.1739.32552.SYNA0001:00 06CB:7F28 Touchpad"."TapDragLock" = true;
      "kcminputrc"."Libinput.1739.32552.SYNA0001:00 06CB:7F28 Touchpad"."TapToClick" = true;
      "kcminputrc"."Libinput.7847.100.2.4G Mouse"."MiddleButtonEmulation" = true;
      "kcminputrc"."Libinput.7847.100.2.4G Mouse"."PointerAccelerationProfile" = 2;
      "kcminputrc"."Libinput.7847.100.2.4G Mouse"."ScrollFactor" = 2;
      ...
      "kdeglobals"."DirSelect Dialog"."DirSelectDialog Size" = "1179,747";
      "kdeglobals"."General"."AllowKDEAppsToRememberWindowPositions" = true;
      "kdeglobals"."General"."XftAntialias" = true;
      "kdeglobals"."General"."XftHintStyle" = "hintfull";
      "kdeglobals"."General"."XftSubPixel" = "vrgb";
      "kdeglobals"."General"."fixed" = "Monospace,14,-1,5,50,0,0,0,0,0";
      "kdeglobals"."General"."font" = "等距更纱黑体 SC,14,-1,5,50,0,0,0,0,0";
      "kdeglobals"."General"."menuFont" = "等距更纱黑体 SC,12,-1,5,50,0,0,0,0,0";
      "kdeglobals"."General"."smallestReadableFont" = "等距更纱黑体 SC,12,-1,5,50,0,0,0,0,0";
      "kdeglobals"."General"."toolBarFont" = "等距更纱黑体 SC,12,-1,5,50,0,0,0,0,0";
      ...
      "kdeglobals"."KFileDialog Settings"."Speedbar Width" = 116;
      "kdeglobals"."KFileDialog Settings"."View Style" = "DetailTree";
      "kdeglobals"."WM"."activeBackground" = "24,25,38";
      "kdeglobals"."WM"."activeBlend" = "24,25,38";
      "kdeglobals"."WM"."activeFont" = "等距更纱黑体 SC,12,-1,5,50,0,0,0,0,0";
      ...
      "kglobalshortcutsrc"."org.kde.dolphin.desktop"."_k_friendly_name" = "Dolphin 文件管理器";
      "kglobalshortcutsrc"."org.kde.kcalc.desktop"."_k_friendly_name" = "KCalc";
      "kglobalshortcutsrc"."org.kde.konsole.desktop"."_k_friendly_name" = "Konsole 命令行终端";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{95c79ea7-5276-4c6b-9516-33704f8ba734}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{2fea85c6-79ee-4c92-b4d2-ce7b268c3e25}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{40afd13c-cfa2-41f5-b05b-1a43db4f61d0}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{52a59c3c-5c71-4242-94f8-1a43152f3975}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{088bdd83-572c-47a9-a41f-9b7ee7996d61}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{7e627d1b-585f-4ce2-b1c0-8890900026d4}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{167196ae-fb2a-49d4-a6e9-7c467de005a5}";
      ...
      "krunnerrc"."Plugins"."PIM Contacts Search RunnerEnabled" = false;
      ...
      "kwinrc"."Desktops"."Id_1" = "c20bdef5-6f73-4585-809e-a32394659de1";
      "kwinrc"."Desktops"."Id_2" = "1f48461f-de5c-48dc-b4c6-6a9b21b58f8f";
      "kwinrc"."Desktops"."Id_3" = "77910455-3cb1-4330-9afa-b1adb1177b3f";
      "kwinrc"."Desktops"."Id_4" = "8f3c88fd-f405-462b-93f1-665ce82359ab";
      "kwinrc"."Desktops"."Number" = 4;
      "kwinrc"."Desktops"."Rows" = 1;
      "kwinrc"."NightColor"."Active" = true;
      "kwinrc"."NightColor"."LatitudeAuto" = 49.7498;
      "kwinrc"."NightColor"."LongitudeAuto" = 6.1661;
      ...
      "plasma-localerc"."Translations"."LANGUAGE" = "zh_CN:en_GB";
      ...
      "systemsettingsrc"."KDiskFree"."Full%" = 69;
      "systemsettingsrc"."KDiskFree"."HeaderSectionIndices" = "0,1,2,3,4,5,6,7";
      "systemsettingsrc"."KDiskFree"."Icon" = 69;
      ...
      "systemsettingsrc"."KDiskFree"."UsageBar" = 453;
