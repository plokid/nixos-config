...
function Logo:decide_enabled()
	self.enabled = state.idlescreen and state.is_idle
end
function Logo:on_prop_is_idle()
	self:decide_enabled()
end
function Logo:on_prop_idlescreen()
	self:decide_enabled()
end
